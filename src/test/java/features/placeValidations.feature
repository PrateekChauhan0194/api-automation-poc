Feature: Validating Place APIs
	Scenario Outline: Verify the successful addition of place using "<serviceName>"
		...
		And user has request payload ready for "<serviceName>"
			|expectedStatusCode		|contentType 	|accuracy |address 						|language  |phoneNumber 		|website 						|name			|
			|<expectedStatusCode>	|<contentType>	|50       |29, side layout, cohen 09	|French-IN |(+91) 983 893 3937	|https://rahulshettyacademy.com |Frontline house|
